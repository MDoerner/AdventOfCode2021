import adventOfCode2021.daySolutions.Day4
import adventOfCode2021.daySolutions.DaySolver
import org.junit.jupiter.api.Test

class Day4Tests: DayTestBase() {
    ...
    internal fun part1Example() {
        ...
        val expectedResult = 4512.toString()
        testExampleInput(1, input, expectedResult)
    }

    @Test
    internal fun part1Solution() {
        val expectedResult = 72770.toString()
        testOnDayInput(4, 1, expectedResult)
    }

    @Test
    internal fun part2Example() {
        val input = part2ExampleInput
        val expectedResult = 1924.toString()
        testExampleInput(2, input, expectedResult)
    }

    @Test
    internal fun part2Solution() {
        val expectedResult = 13912.toString()
        testOnDayInput(4, 2, expectedResult)
    }
}